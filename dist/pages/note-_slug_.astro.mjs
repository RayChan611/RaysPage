...
async function getStaticPaths() {
  const notes = (await getCollection("notes")).filter((n) => n.data.hasDetail);
  return notes.map((entry) => ({
    params: { slug: entry.slug },
    props: { entry }
  }));
}
const $$Noteslug = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Noteslug;
...
}, "/Users/ray/PersonalProject/rayspage-astro/site/src/pages/note-[slug].astro", void 0);

const $$file = "/Users/ray/PersonalProject/rayspage-astro/site/src/pages/note-[slug].astro";
const $$url = "/note-[slug].html";
